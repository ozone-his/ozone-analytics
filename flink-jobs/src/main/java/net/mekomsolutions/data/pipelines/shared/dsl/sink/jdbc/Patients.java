 ...
 */
public class Patients  implements TableSQLDSL {
    private Map<String, String> connectorOptions;
    public Patients(Map<String, String> connectorOptions) {
        if(!Objects.equals(connectorOptions.get("connector"), "filesystem")){
            connectorOptions.put("table-name","patients");
        }else{
            connectorOptions.put("path","/tmp/analytics/patients");
        }
