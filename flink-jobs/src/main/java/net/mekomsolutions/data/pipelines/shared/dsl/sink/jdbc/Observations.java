 ...
 */
public class Observations implements TableSQLDSL {
    private Map<String, String> connectorOptions;
    public Observations(Map<String, String> connectorOptions) {
        if(!Objects.equals(connectorOptions.get("connector"), "filesystem")){
            connectorOptions.put("table-name","observations");
        }else{
            connectorOptions.put("path","/tmp/analytics/observations");
        }
